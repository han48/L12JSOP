<div data-controller="chart" data-chart-parent="#{{ $slug }}" data-chart-labels="{{ $labels }}"
    data-chart-datasets="{{ $data }}" data-chart-type="{{ $type }}" data-chart-height="{{ $height }}"
    data-chart-colors="{{ $colors }}" data-chart-max-slices="{{ $maxSlices }}"
    data-chart-values-over-points="{{ $valuesOverPoints }}" data-chart-axis-options="{{ $axisOptions }}"
    data-chart-bar-options="{{ $barOptions }}" data-chart-line-options="{{ $lineOptions }}"
