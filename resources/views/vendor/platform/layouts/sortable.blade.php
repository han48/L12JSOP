...
<div class="mb-3 rounded shadow-sm overflow-hidden">
    @if ($rows->isNotEmpty())
        <ol data-controller="sortable" data-sortable-selector-value=".reorder-handle"
            ...
            data-sortable-failure-message-value="{{ $failureSortMessage }}" class="list-group">

            @foreach ($rows as $model)
                <li data-model-id="{{ $model->getKey() }}"
