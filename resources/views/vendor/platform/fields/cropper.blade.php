        ...
        <div class="border-dashed text-end p-3 cropper-actions">
            ...
            <div class="btn-group">
                <label class="btn btn-default m-0">
                    ...
                    {{ __('Browse') }}
                    <input type="file" accept="{{ $acceptedFiles }}" data-cropper-target="upload"
                        data-action="change->cropper#upload click->cropper#openModal" class="d-none">
                </label>
            ...
            <input type="file" accept="{{ $acceptedFiles }}" class="d-none">
        </div>

        <input class="cropper-path d-none" type="text" data-cropper-target="source" {{ $attributes }}>
