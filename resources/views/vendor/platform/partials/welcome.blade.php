<div class="bg-white rounded-top shadow-sm mb-4 rounded-bottom">
    ...
    <div class="row g-0">
        ...
        <div class="d-none d-lg-block col align-self-center text-end text-muted p-4 opacity-25">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" role="img" width="6em" height="100%"
                viewBox="0 0 100 100">
                <path
    ...
    <div class="row bg-light m-0 p-md-4 p-3 border-top rounded-bottom g-md-5 text-balance">
        ...
        <div class="col-md-6 my-2">
            ...
            <p class="ms-md-5 ps-md-1">
                ...
                limitless creativity with our comprehensive <a href="https://orchid.software/en/docs" target="_blank"
                    class="text-u-l">documentation</a>.
            </p>
        </div>
        ...
        <div class="col-md-6 my-2">
            ...
            <p class="ms-md-5 ps-md-1">
                ...
                features, be sure to <a href="https://orchid.software/en/docs/quickstart" target="_blank"
                    class="text-u-l">check out the step-by-step tutorials</a> see on the site.
            </p>
        </div>
        ...
        <div class="col-md-6 my-2">
            ...
            <div class="ms-md-5 ps-md-1">
                <p>
                    Connect with the Laravel Orchid community by following <a href="https://twitter.com/orchid_platform"
                        class="text-u-l">@orchid_platform</a> on Twitter and joining the
                    official <a href="https://t.me/orchid_community" class="text-u-l">Telegram group</a> for updates,
                    news, and support from the community. Stay informed and be a
