<button formaction="{{ url()->current() }}/{{ $notification->id }}/maskNotification" type="submit"
    class="btn btn-link text-start p-4 d-flex align-items-baseline">

    <small
        class="align-self-start me-2 text-{{ $notification->data['type'] }} @if ($notification->read()) opacity @endif">
